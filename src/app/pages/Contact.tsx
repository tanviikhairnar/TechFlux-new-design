            ...
            >
              ...
              <form className="space-y-5" onSubmit={onSubmit}>
                ...
                <button
                  ...
                  className="flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#38A9FF] to-[#2B7BDF] px-8 py-3.5 text-sm font-semibold text-white shadow-[0_0_24px_rgba(56,169,255,0.35)] transition-all hover:brightness-110 active:brightness-110 md:text-[15px]"
                >
            ...
            >
              ...
              >
                ...
                <a
                  ...
                  className="absolute bottom-3 right-3 rounded-lg bg-[#0b1f3f]/90 px-3 py-1.5 text-xs font-medium text-[#E5E7EB] backdrop-blur transition-colors hover:bg-[#12315f] active:bg-[#12315f]"
                >
                  Open in Google Maps
                </a>
              </div>
              ...
              <div className="rounded-2xl border border-white/5 p-6 text-center md:p-8" style={{ background: 'rgba(255,255,255,0.03)' }}>
                ...
                <Link
                  ...
                  className="inline-flex rounded-xl bg-gradient-to-r from-[#38A9FF] to-[#2B7BDF] px-8 py-3 text-sm font-semibold text-white shadow-[0_0_24px_rgba(56,169,255,0.35)] transition-all hover:brightness-110 active:brightness-110 md:text-[15px]"
                >
                  Book Strategy Call
                </Link>
              </div>
