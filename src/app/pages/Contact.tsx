          ...
          <div className="grid gap-8 lg:grid-cols-[1.02fr_1fr]">
            ...
            >
              ...
              <form className="space-y-5">
                <div>
                  <label className="mb-2 block text-base font-medium text-[#E5E7EB]">Name</label>
                  <input
                    type="text"
                    placeholder="Your name"
                    className="w-full rounded-xl border border-[#203A64] bg-[#0E1A31] px-4 py-3 text-[#E5E7EB] placeholder:text-[#6F819E] focus:border-[#2F80ED] focus:outline-none"
                  />
                </div>

                <div>
                  <label className="mb-2 block text-base font-medium text-[#E5E7EB]">Email</label>
                  <input
                    type="email"
                ...
                <div>
                  <label className="mb-2 block text-base font-medium text-[#E5E7EB]">Company</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="mb-2 block text-base font-medium text-[#E5E7EB]">Project Type</label>
                  <select className="w-full rounded-xl border border-[#203A64] bg-[#0E1A31] px-4 py-3 text-[#E5E7EB] focus:border-[#2F80ED] focus:outline-none">
                ...
                <div>
                  <label className="mb-2 block text-base font-medium text-[#E5E7EB]">Budget</label>
                  <select className="w-full rounded-xl border border-[#203A64] bg-[#0E1A31] px-4 py-3 text-[#E5E7EB] focus:border-[#2F80ED] focus:outline-none">
                ...
                <div>
                  <label className="mb-2 block text-base font-medium text-[#E5E7EB]">Message</label>
                  <textarea
                    rows={4}
                    placeholder="Tell us about your project..."
                    className="w-full resize-none rounded-xl border border-[#203A64] bg-[#0E1A31] px-4 py-3 text-[#E5E7EB] placeholder:text-[#6F819E] focus:border-[#2F80ED] focus:outline-none"
                  />
                </div>

                <button
                  type="submit"
                  className="flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#38A9FF] to-[#2B7BDF] px-8 py-4 text-base font-semibold text-white shadow-[0_0_24px_rgba(56,169,255,0.35)] transition-all hover:brightness-110"
                >
            ...
            >
              ...
              <div className="rounded-2xl border border-white/5 p-6 text-center md:p-8" style={{ background: 'rgba(255,255,255,0.03)' }}>
                ...
                <p className="mb-6 text-base text-[#94A3B8]">Schedule a strategy call to discuss your project in detail.</p>
                <Link
                  to="/book-strategy-call"
                  className="inline-flex rounded-xl bg-gradient-to-r from-[#38A9FF] to-[#2B7BDF] px-8 py-3 text-base font-semibold text-white shadow-[0_0_24px_rgba(56,169,255,0.35)] transition-all hover:brightness-110"
                >
                  Book Strategy Call
                </Link>
              </div>
