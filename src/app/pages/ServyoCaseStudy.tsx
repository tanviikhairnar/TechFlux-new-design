        ...
        <section className="mx-auto w-full max-w-[1260px] px-4 pb-20 lg:px-5">
          <div className="grid gap-6 md:grid-cols-2">
            <motion.div
              ...
              viewport={{ once: true }}
              className="rounded-2xl border border-white/6 bg-[#101A31] p-6 transition-all duration-300 hover:-translate-y-1 active:-translate-y-1 hover:border-[#2F80ED]/30 active:border-[#2F80ED]/30 hover:shadow-lg active:shadow-lg hover:shadow-[#2F80ED]/20 active:shadow-[#2F80ED]/20"
            >
          ...
          <div className="mx-auto w-full max-w-[1260px] px-4 lg:px-5">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {techStack.map((item) => (
                <div
                  key={item.label}
                  className="rounded-xl border border-white/6 bg-[#111D33] px-5 py-6 text-center transition-all duration-300 hover:-translate-y-1 active:-translate-y-1 hover:border-[#2F80ED]/30 active:border-[#2F80ED]/30 hover:shadow-lg active:shadow-lg hover:shadow-[#2F80ED]/20 active:shadow-[#2F80ED]/20"
                >
          ...
          <div className="mx-auto w-full max-w-[1260px] px-4 lg:px-5">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {resultItems.map((item) => (
                <div
                  key={item}
                  className="rounded-xl border border-white/6 bg-[#111D33] px-5 py-4 text-[#C4D4EA] transition-all duration-300 hover:-translate-y-1 active:-translate-y-1 hover:border-[#2F80ED]/30 active:border-[#2F80ED]/30 hover:shadow-lg active:shadow-lg hover:shadow-[#2F80ED]/20 active:shadow-[#2F80ED]/20"
                >
