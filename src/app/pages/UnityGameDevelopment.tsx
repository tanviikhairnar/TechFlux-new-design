    ...
    <div className="w-full min-h-screen overflow-x-hidden bg-[#0B0F1A]" style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      <main className="relative overflow-hidden">
            ...
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                <Link
                  ...
                  className="inline-flex h-[52px] items-center rounded-xl bg-gradient-to-r from-[#39AEFE] to-[#2F80ED] px-7 text-sm font-semibold text-white shadow-[0_0_24px_rgba(47,128,237,0.35)] transition-all duration-200 hover:-translate-y-0.5 active:-translate-y-0.5 hover:brightness-110 active:brightness-110 hover:shadow-[0_10px_30px_rgba(47,128,237,0.45)] active:shadow-[0_10px_30px_rgba(47,128,237,0.45)]"
                >
                  Book Strategy Call
                </Link>
                <GetProjectEstimateButton className="inline-flex h-[52px] items-center rounded-xl border border-[#2F80ED] px-7 text-sm font-semibold text-[#6EB8FF] transition-all duration-200 hover:-translate-y-0.5 active:-translate-y-0.5 hover:bg-[#2F80ED]/10 active:bg-[#2F80ED]/10 hover:shadow-[0_8px_24px_rgba(19,77,151,0.3)] active:shadow-[0_8px_24px_rgba(19,77,151,0.3)]" />
              </div>
            </motion.div>
        ...
        <CardsSection
          ...
          cardClassName="group rounded-2xl border border-white/5 bg-[#0C1830] p-6 transition-all duration-300 hover:border-[#2F80ED]/35 active:border-[#2F80ED]/35 hover:shadow-[0_14px_36px_rgba(16,53,110,0.32)] active:shadow-[0_14px_36px_rgba(16,53,110,0.32)]"
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {expertise.map((item, i) => (
                <motion.div
                  ...
                  className="group rounded-2xl border border-white/5 bg-[#0F172A] p-10 transition-all duration-300 hover:border-[#2F80ED]/35 active:border-[#2F80ED]/35 hover:shadow-[0_14px_36px_rgba(16,53,110,0.32)] active:shadow-[0_14px_36px_rgba(16,53,110,0.32)]"
                >
            ...
            <div className="grid grid-cols-2 gap-x-4 gap-y-4 sm:grid-cols-3 lg:grid-cols-6">
              {techStack.map((item, i) => (
                <motion.div
                  ...
                  className="unity-chip flex h-[118px] flex-col items-center justify-center rounded-[20px] border border-[#24324C]/70 bg-[#111A2D] px-4 py-4 text-center transition-all hover:border-[#2F80ED]/35 active:border-[#2F80ED]/35"
                >
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              {process.map((item, i) => (
                <motion.div
                  ...
                  className="group relative overflow-hidden rounded-2xl border border-white/5 bg-[#0E1628] p-6 md:p-7 transition-all duration-300 hover:-translate-y-1 active:-translate-y-1 hover:border-[#2F80ED]/25 active:border-[#2F80ED]/25 hover:shadow-[0_20px_50px_rgba(0,0,0,0.45)] active:shadow-[0_20px_50px_rgba(0,0,0,0.45)]"
                >
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {projects.map((item, i) => (
                <motion.div
                  ...
                  className="group overflow-hidden rounded-2xl border border-white/5 bg-[#0F172A] transition-all duration-300 hover:border-[#2F80ED]/35 active:border-[#2F80ED]/35 hover:shadow-[0_14px_36px_rgba(16,53,110,0.32)] active:shadow-[0_14px_36px_rgba(16,53,110,0.32)]"
                >
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              {whyTechflux.map((item, i) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: i * 0.06 }}
                  className="group rounded-2xl border border-white/5 bg-[#0F172A] p-6 transition-all duration-300 hover:border-[#2F80ED]/35 active:border-[#2F80ED]/35 hover:shadow-[0_14px_36px_rgba(16,53,110,0.32)] active:shadow-[0_14px_36px_rgba(16,53,110,0.32)]"
                >
          ...
          <div className="tf-shell">
            ...
            >
              ...
              <div className="mt-8 flex flex-col justify-center gap-4 sm:flex-row">
                <Link
                  to="/book-strategy-call"
                  className="inline-flex h-[50px] items-center justify-center rounded-xl bg-gradient-to-r from-[#39AEFE] to-[#2F80ED] px-8 text-sm font-semibold text-white transition-all duration-200 hover:-translate-y-0.5 active:-translate-y-0.5 hover:brightness-110 active:brightness-110 hover:shadow-[0_10px_28px_rgba(47,128,237,0.45)] active:shadow-[0_10px_28px_rgba(47,128,237,0.45)]"
                >
                  Book Strategy Call
                </Link>
                <GetProjectEstimateButton className="inline-flex h-[50px] items-center justify-center rounded-xl border border-[#2F80ED] px-8 text-sm font-semibold text-[#69B7FF] transition-all duration-200 hover:-translate-y-0.5 active:-translate-y-0.5 hover:bg-[#2F80ED]/10 active:bg-[#2F80ED]/10 hover:shadow-[0_8px_24px_rgba(19,77,151,0.3)] active:shadow-[0_8px_24px_rgba(19,77,151,0.3)]" />
              </div>
            </motion.div>
          </div>
        </section>
