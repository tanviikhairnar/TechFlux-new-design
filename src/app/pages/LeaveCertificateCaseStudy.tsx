...
const challengeItems = [
  ...
  'Need for secure digital record storage',
  'Semester-based data organization requirements',
  'Duplicate certificate request handling',
  'Role-based access control for multiple user types',
];

const architectureItems = ['SaaS Platform', 'Digital Records', 'Role-Based Access', 'Cloud Storage'];

const featureItems = [
  { title: 'Digital Record Storage', subtitle: 'Secure cloud-based certificate repository' },
  { title: 'Semester-Based Organization', subtitle: 'Structured data management by academic terms' },
  { title: 'Duplicate Certificate Logic', subtitle: 'Automated duplicate request handling' },
  { title: 'Role-Based Admin Access', subtitle: 'Multi-level permission system' },
  { title: 'Instant Retrieval', subtitle: 'Fast search and download capabilities' },
  { title: 'Audit Trail', subtitle: 'Complete activity logging and tracking' },
];
...
const impactItems = [
  {
    ...
    text: 'Reduced certificate processing time by 80%',
  },
  {
    icon: CheckCircle2,
    title: 'Data Security',
    text: 'Secure digital storage with backup systems',
  },
  {
    icon: Users,
    title: 'Improved Access',
    text: 'Instant certificate access for students and staff',
  },
  {
    icon: TrendingUp,
    title: 'Scalability',
    text: 'Platform supports growing student databases',
  },
];

export default function LeaveCertificateCaseStudy() {
  return (
    <div className="min-h-screen w-full overflow-x-hidden bg-[#020617]" style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      <main className="relative">
        ...
        <section className="relative z-10 mx-auto flex w-full max-w-[1260px] items-center px-4 pb-24 pt-[7.5rem] md:pb-28 md:pt-[8.5rem] lg:px-5">
          ...
          <Link to="/case-studies" className="mb-6 inline-flex items-center gap-2 text-sm text-[#6DB6FF] hover:text-white active:text-white">
          ...
          <div className="grid items-center gap-10 lg:grid-cols-[1fr_1.05fr]">
            ...
            >
              ...
              <p className="mb-4 max-w-xl text-base leading-relaxed text-[#94A3B8] md:text-lg">
                Leave Certificate is a SaaS platform designed for educational institutions to digitize and automate
                the management of student certificates. The system streamlines the process of issuing, storing, and
                retrieving academic certificates.
              </p>

              <div className="mb-6 flex flex-wrap gap-2">
                {['SaaS Platform', 'Digital Records', 'Role-Based Access', 'Cloud Storage'].map((tag) => (
              ...
              <div className="flex flex-wrap gap-3">
                <Link
                  to="/get-estimate"
                  className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-[#39AEFE] to-[#2F80ED] px-7 py-3 text-sm font-semibold text-white shadow-[0_0_24px_rgba(47,128,237,0.35)] transition-all duration-200 hover:-translate-y-0.5 active:-translate-y-0.5 hover:brightness-110 active:brightness-110"
                >
          ...
          <div className="mx-auto w-full max-w-[1260px] space-y-14 px-4 lg:px-5">
            ...
            <div>
              ...
              <p className="mb-6 max-w-5xl text-sm leading-relaxed text-[#94A3B8] md:text-base">
                We developed a comprehensive SaaS platform with secure digital storage, automated certificate
                generation, semester-based data management, and role-based admin access controls. The system supports
                duplicate certificate logic and provides instant certificate retrieval.
              </p>
