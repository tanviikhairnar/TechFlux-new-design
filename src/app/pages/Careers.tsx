...
const teamPhoto = "https://techflux.in/public/assets/images/team-photo.webp";
const workspacePhoto = "https://techflux.in/public/assets/images/studionewmedia.webp"
          ...
          <section className="mb-20 grid min-h-[calc(100vh-150px)] gap-10 lg:grid-cols-[1fr_1.12fr] lg:items-center">
            <motion.div initial={{ opacity: 0, x: -26 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.65 }}>
              ...
              <button
                ...
                className="tf-cta-feedback inline-flex rounded-2xl bg-gradient-to-r from-[#39AEFE] to-[#2F80ED] px-10 py-4 text-base font-semibold text-white shadow-[0_0_24px_rgba(56,169,255,0.35)] transition-all duration-300 hover:-translate-y-0.5 active:-translate-y-0.5 hover:brightness-110 active:brightness-110"
              >
                View Open Positions
              </button>
            </motion.div>
            ...
            <motion.div
              ...
              className="overflow-hidden rounded-2xl border border-white/10 transition-all duration-300 hover:-translate-y-1 active:-translate-y-1 hover:border-[#2F80ED]/30 active:border-[#2F80ED]/30 hover:shadow-lg active:shadow-lg hover:shadow-[#2F80ED]/20 active:shadow-[#2F80ED]/20"
            >
              <img
                src={teamPhoto}
            ...
            <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
              {whyWorkItems.map((item, index) => (
                <motion.div
                  ...
                  className="flex min-h-[320px] flex-col items-center rounded-3xl border border-white/5 p-8 text-center transition-all duration-300 hover:-translate-y-1 active:-translate-y-1 hover:border-[#2F80ED]/30 active:border-[#2F80ED]/30 hover:shadow-lg active:shadow-lg hover:shadow-[#2F80ED]/20 active:shadow-[#2F80ED]/20"
            ...
            <div className="space-y-6">
              {positions.map((position, index) => (
                <motion.article
                  ...
                  className="rounded-3xl border border-[#233554] bg-[#121f38] px-7 py-6 transition-all duration-300 hover:border-[#2F80ED]/35 active:border-[#2F80ED]/35 hover:shadow-lg active:shadow-lg hover:shadow-[#2F80ED]/20 active:shadow-[#2F80ED]/20 md:px-8 md:py-7"
                >
                  <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
                    ...
                    <div className="flex w-full shrink-0 flex-col gap-3 sm:flex-row md:w-auto md:flex-col">
                      <CareerViewDetailsButton
                        slug={position.slug}
                        role={position}
                        className="w-full rounded-2xl border border-[#35507C] bg-[#25334B] px-6 py-3 text-center text-base font-medium text-[#D5E6FF] transition-all duration-300 hover:bg-[#2A3D5D] active:bg-[#2A3D5D] sm:flex-1 md:min-w-[220px] md:flex-none"
                      />
                      <CareerApplyNowButton
                        positionTitle={position.title}
                        role={position}
                        className="w-full rounded-2xl bg-gradient-to-r from-[#39AEFE] to-[#2F80ED] px-6 py-3 text-center text-base font-semibold text-white shadow-[0_10px_28px_rgba(47,128,237,0.35)] transition-all duration-300 hover:brightness-110 active:brightness-110 sm:flex-1 md:min-w-[220px] md:flex-none"
                      />
                    </div>
                  </div>
                </motion.article>
            ...
            <div className="relative grid gap-5 md:grid-cols-2 xl:grid-cols-5">
              {hiringProcess.map((step, index) => (
                <motion.div
                  ...
                  className="relative rounded-3xl border border-white/5 p-7 text-center transition-all duration-300 hover:-translate-y-1 active:-translate-y-1 hover:border-[#2F80ED]/30 active:border-[#2F80ED]/30 hover:shadow-lg active:shadow-lg hover:shadow-[#2F80ED]/20 active:shadow-[#2F80ED]/20"
                  style={{ background: 'rgba(255,255,255,0.03)' }}
                >
          ...
          <div className="mx-auto w-full max-w-[1260px] px-4 lg:px-5">
            ...
            >
              ...
              <div className="mb-10 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
                {lifeCards.map((card, index) => (
                  <motion.article
                    ...
                    viewport={{ once: true }}
                    transition={{ delay: index * 0.07 }}
                    className="overflow-hidden rounded-3xl border border-white/5 transition-all duration-300 hover:-translate-y-1 active:-translate-y-1 hover:border-[#2F80ED]/30 active:border-[#2F80ED]/30 hover:shadow-lg active:shadow-lg hover:shadow-[#2F80ED]/20 active:shadow-[#2F80ED]/20"
                    style={{ background: 'rgba(255,255,255,0.03)' }}
                  >
              ...
              <div className="rounded-3xl border border-white/5 p-10 text-center md:p-14" style={{ background: 'rgba(255,255,255,0.03)' }}>
                ...
                <button
                  onClick={scrollToOpenPositions}
                  className="tf-cta-feedback inline-flex rounded-2xl bg-gradient-to-r from-[#39AEFE] to-[#2F80ED] px-12 py-4 text-base font-semibold text-white shadow-[0_0_24px_rgba(56,169,255,0.35)] transition-all duration-300 hover:-translate-y-0.5 active:-translate-y-0.5 hover:brightness-110 active:brightness-110"
                >
