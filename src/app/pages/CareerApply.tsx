      ...
      <main className="relative">
        ...
        <section className="relative z-10 bg-[#09152B]/80">
          <div className="mx-auto w-full max-w-[1260px] px-4 pb-14 pt-28 md:pt-32 lg:px-5">
            <Link
              to="/careers"
              className="mb-6 inline-flex items-center gap-2 text-sm font-medium text-[#60A5FA] transition-colors hover:text-[#93C5FD] active:text-[#93C5FD]"
            >
          ...
          <div className="mx-auto w-full max-w-[760px] px-4 lg:px-5">
            ...
            >
              ...
              <label
                ...
                className="tf-cta-feedback mt-3 flex cursor-pointer flex-col items-center justify-center rounded-xl border border-dashed border-[#2A3D5D] bg-[#0A1830] px-5 py-8 text-center transition-all hover:border-[#2F80ED] active:border-[#2F80ED]"
              >
              ...
              <div className="mt-8 grid gap-3 sm:grid-cols-2">
                <button
                  ...
                  className="tf-cta-feedback h-12 rounded-xl bg-gradient-to-r from-[#39AEFE] to-[#2F80ED] text-base font-semibold text-white transition-all hover:brightness-110 active:brightness-110 disabled:cursor-not-allowed disabled:opacity-70"
                >
                  {isSubmitting ? 'Submitting...' : showSuccessOnButton ? 'Application Submitted' : 'Submit Application'}
                </button>
                <Link
                  to="/careers"
                  className="tf-cta-feedback inline-flex h-12 items-center justify-center rounded-xl border border-[#2C3C56] bg-[#1B2434] text-base font-medium text-[#E5E7EB] transition-all hover:bg-[#25334B] active:bg-[#25334B]"
                >
                  Cancel
                </Link>
              </div>
