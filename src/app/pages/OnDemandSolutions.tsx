...
const onDemandHeroImage = "https://techflux.in/public/assets/images/studionewmedia.webp"
      ...
      <main className="relative">
        ...
        <ServiceHeroSection
          ...
          primaryCta={{
            ...
            to: '/get-estimate',
            className:
              'inline-flex h-[52px] items-center justify-center rounded-[10px] border border-[#2F80ED] px-8 text-sm font-semibold text-[#4CA1FF] transition-all hover:bg-[#2F80ED]/10 active:bg-[#2F80ED]/10',
          }}
          secondaryCta={{
