...
const challengeItems = [
  ...
  'AI-powered personalization engine requirements',
  'Privacy and health data security compliance',
  'Meaningful insight generation from raw biometric data',
];

const architectureItems = ['AI Engine', 'Smartwatch Integration', 'Health Analytics', 'Machine Learning'];

const featureItems = [
  { title: 'Smartwatch Data Integration', subtitle: 'Real-time sync with major wearable devices' },
  { title: 'AI Recommendation Engine', subtitle: 'Machine learning-powered health insights' },
  { title: 'Personalized Health Insights', subtitle: 'Customized wellness guidance' },
  { title: 'Biometric Analysis', subtitle: 'Advanced health metric processing' },
  { title: 'Trend Tracking', subtitle: 'Long-term health pattern analysis' },
  { title: 'Goal Setting', subtitle: 'Personalized wellness objectives' },
];
...
const impactItems = [
  {
    ...
    text: 'Intelligent health recommendations',
  },
  {
    icon: Users,
    title: 'Personalized Experience',
    text: 'Tailored wellness guidance for each user',
  },
  {
    icon: CheckCircle2,
    title: 'Data Security',
    text: 'HIPAA-compliant health data protection',
  },
  {
    icon: TrendingUp,
    title: 'Health Improvement',
    text: 'Users achieving wellness goals faster',
  },
];

export default function Etern8CaseStudy() {
  return (
          ...
          <div className="grid items-center gap-10 lg:grid-cols-[1fr_1.05fr]">
            ...
            >
              ...
              <p className="mb-4 max-w-xl text-base leading-relaxed text-[#94A3B8] md:text-lg">
                Etern 8 is an AI-driven wellness platform that integrates smartwatch data to deliver personalized
                health insights and recommendations. The platform analyzes biometric data to provide actionable wellness
                guidance.
              </p>

              <div className="mb-6 flex flex-wrap gap-2">
                {['AI Engine', 'Smartwatch Integration', 'Health Analytics', 'Machine Learning'].map((tag) => (
          ...
          <div className="mx-auto w-full max-w-[1260px] space-y-14 px-4 lg:px-5">
            ...
            <div>
              ...
              <p className="mb-6 max-w-5xl text-sm leading-relaxed text-[#94A3B8] md:text-base">
                We developed an AI-powered platform with seamless smartwatch integration, real-time data processing,
                machine learning-based recommendation engine, HIPAA-compliant security, and personalized health insight
                delivery.
              </p>
