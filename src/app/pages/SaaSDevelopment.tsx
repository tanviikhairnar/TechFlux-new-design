            ...
            <div className="grid gap-5 md:grid-cols-3">
              {whyTechflux.map((item, i) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: i * 0.05 }}
                  className="rounded-2xl border border-[#1E2D45] bg-[#111D36] p-8 transition-all duration-300 hover:border-[#2F80ED]/35 active:border-[#2F80ED]/35"
                >
            ...
            <div className="grid gap-3 sm:grid-cols-2 md:grid-cols-5">
              {relatedServices.map((service) => (
                <motion.div key={service.title} whileHover={{ y: -3 }} transition={{ duration: 0.2 }}>
                  <Link
                    to={service.to}
                    className="flex min-h-[58px] items-center justify-center rounded-lg border border-white/5 bg-[#0C1830] px-4 py-3 text-center text-sm font-medium text-[#D7E2F6] transition-all duration-300 hover:-translate-y-1 active:-translate-y-1 hover:border-[#2F80ED]/35 active:border-[#2F80ED]/35 hover:bg-[#112241] active:bg-[#112241] hover:text-white active:text-white"
                  >
                    {service.title}
                  </Link>
                </motion.div>
