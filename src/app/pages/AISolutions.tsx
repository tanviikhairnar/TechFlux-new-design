      ...
      <main className="relative">
        ...
        <ServiceHeroSection
          ...
          primaryCta={{
            ...
            to: '/get-estimate',
            className:
              'inline-flex h-[52px] items-center justify-center rounded-[10px] bg-gradient-to-r from-[#39AAFF] to-[#2A79D9] px-8 text-sm font-semibold text-white shadow-[0_0_22px_rgba(56,169,255,0.28)] transition-all hover:brightness-110 active:brightness-110',
          }}
          secondaryCta={{
            label: 'Book Strategy Call',
            to: '/book-strategy-call',
            className:
              'inline-flex h-[52px] items-center justify-center rounded-[10px] border border-white/10 bg-[#111A2D] px-8 text-sm font-semibold text-[#D8DEE8] transition-all hover:border-[#2F80ED]/45 active:border-[#2F80ED]/45 hover:bg-[#15233E] active:bg-[#15233E]',
          }}
            ...
            <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
              {aiSolutions.map((item, i) => (
                <motion.div
                  ...
                  className="group rounded-2xl border border-white/8 bg-[linear-gradient(110deg,#141F38_0%,#121C33_100%)] p-6 transition-all duration-300 hover:-translate-y-1 active:-translate-y-1 hover:border-[#2F80ED]/35 active:border-[#2F80ED]/35 hover:shadow-[0_14px_36px_rgba(16,53,110,0.32)] active:shadow-[0_14px_36px_rgba(16,53,110,0.32)]"
                >
          ...
          <div className="mx-auto w-full max-w-[1260px] px-4 lg:px-5">
            ...
            >
              ...
              <div className="flex flex-col justify-center gap-4 sm:flex-row">
                ...
                <GetProjectEstimateButton className="rounded-[10px] border border-[#2F80ED] px-8 py-3 text-sm font-medium text-[#4CA1FF] hover:bg-[#2F80ED]/10 active:bg-[#2F80ED]/10" />
              </div>
            </motion.div>
          </div>
        </section>
        ...
        <section className="bg-[#081327] py-20">
          <div className="mx-auto w-full max-w-[1260px] px-4 lg:px-5">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center">
              ...
              <Link
                to="/book-strategy-call"
                className="inline-flex h-[52px] items-center rounded-[10px] bg-gradient-to-r from-[#39AAFF] to-[#2A79D9] px-8 text-sm font-semibold text-white shadow-[0_0_22px_rgba(56,169,255,0.28)] transition-all hover:brightness-110 active:brightness-110"
              >
                Book Strategy Call
              </Link>
            </motion.div>
