        ...
        <div className="relative z-10 mx-auto w-full max-w-[1260px] px-4 pb-20 pt-40 md:pb-24 md:pt-52 lg:px-5">
          ...
          <section className="mb-16">
            ...
            <div className="grid gap-5 md:grid-cols-3">
              {perfectFor.map((item) => (
                <div key={item.title} className="rounded-2xl border border-[#1F2D46] bg-[#111B31] p-7 text-center transition-all duration-300 hover:border-[#2C4B78] active:border-[#2C4B78] hover:bg-[#132039] active:bg-[#132039]">
          ...
          <section className="mb-16">
            ...
            <div className="grid gap-5 md:grid-cols-4">
              {steps.map((item) => (
                <div key={item.number} className="rounded-2xl border border-[#1F2D46] bg-[#111B31] p-6 transition-all duration-300 hover:border-[#2C4B78] active:border-[#2C4B78] hover:bg-[#132039] active:bg-[#132039]">
          ...
          <section className="mb-16">
            ...
            <div className="grid gap-5 md:grid-cols-2">
              {benefits.map((item) => (
                <div key={item.title} className="rounded-2xl border border-[#1F2D46] bg-[#111B31] p-6 transition-all duration-300 hover:border-[#2C4B78] active:border-[#2C4B78] hover:bg-[#132039] active:bg-[#132039]">
              ...
              <form className="space-y-4.5" onSubmit={onSubmit}>
                <div className="grid gap-4 md:grid-cols-2">
                  <div>
                    ...
                    <input
                      ...
                      className="h-11 w-full rounded-xl border border-[#243A62] bg-[#0D1930] px-4 text-sm text-[#E5E7EB] outline-none transition-all duration-300 placeholder:text-[#6F83A2] hover:border-[#2B4D7F] active:border-[#2B4D7F] focus:border-[#2F80ED] focus:shadow-[0_0_0_4px_rgba(47,128,237,0.14)]"
                    />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full rounded-xl border border-[#243A62] bg-[#0D1930] px-4 py-3 text-sm text-[#E5E7EB] outline-none transition-all duration-300 placeholder:text-[#6F83A2] hover:border-[#2B4D7F] active:border-[#2B4D7F] focus:border-[#2F80ED] focus:shadow-[0_0_0_4px_rgba(47,128,237,0.14)]"
                  />
                </div>
                <div>
