...
export function IndustriesSection({
  ...
  cardClassName = 'tf-hover-card group flex min-h-[200px] flex-col items-center justify-center rounded-2xl border border-[#1E2D45] bg-[#111D36] p-7 text-center transition-all duration-300 hover:border-[#2F80ED]/30',
