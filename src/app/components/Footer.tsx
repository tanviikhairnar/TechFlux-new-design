      ...
      <div className="tf-shell pb-10 pt-16">
        ...
        >
            ...
            <div className="flex gap-4">
              {socialLinks.map((item, index) => (
                <motion.a
                  ...
                  className="tf-hover-card flex h-9 w-9 items-center justify-center rounded-lg border border-white/6 bg-white/5 text-[#9CA3AF] transition-all duration-300 hover:border-[#2F80ED]/25 active:border-[#2F80ED]/25 hover:bg-[#2F80ED]/20 active:bg-[#2F80ED]/20 hover:text-[#2F80ED] active:text-[#2F80ED]"
                >
          ...
          <div>
            ...
            <ul className="space-y-3 text-base">
              {quickLinks.map((item) => (
                <li key={item.label}>
                  <Link to={item.to} className="tf-text-link text-[#9CA3AF] transition-colors hover:text-[#2F80ED] active:text-[#2F80ED]">
                    {item.label}
                  </Link>
                </li>
              ))}
        ...
        >
          ...
          <div className="flex flex-col justify-center gap-4 sm:flex-row">
            <BookStrategyCallButton className="tf-button-primary rounded-xl bg-[#2F80ED] px-7 py-3 text-base font-medium text-white transition-all duration-300 hover:-translate-y-1 active:-translate-y-1 hover:bg-[#1C6DD0] active:bg-[#1C6DD0] hover:shadow-lg active:shadow-lg hover:shadow-[#2F80ED]/30 active:shadow-[#2F80ED]/30" />
            <BecomePartnerButton className="tf-button-secondary rounded-xl border border-[#2F80ED] px-7 py-3 text-base font-medium text-[#2F80ED] transition-all duration-300 hover:-translate-y-1 active:-translate-y-1 hover:bg-[#2F80ED]/10 active:bg-[#2F80ED]/10" />
          </div>
        </motion.div>
