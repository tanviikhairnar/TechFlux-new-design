...
export function InvestmentCardsSection({
  ...
  cardClassName = 'tf-hover-card rounded-2xl border border-[#1D2B44] bg-[#101B33] p-8 md:p-10',
  ...
  estimateButtonClassName = 'tf-button-primary inline-flex h-[50px] items-center justify-center rounded-xl bg-gradient-to-r from-[#39AAFF] to-[#2A79D9] px-8 text-sm font-semibold text-white shadow-[0_0_16px_rgba(56,169,255,0.3)] transition-all hover:-translate-y-0.5 hover:brightness-110',
