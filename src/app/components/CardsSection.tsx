...
export function CardsSection({
  ...
  cardClassName = 'tf-hover-card group rounded-2xl border border-white/5 bg-[#0C1830] p-6 transition-[transform,border-color,background-color,box-shadow] duration-300 hover:-translate-y-1 active:-translate-y-1 hover:border-[#2F80ED]/35 active:border-[#2F80ED]/35 hover:bg-[#10203C] active:bg-[#10203C] hover:shadow-[0_14px_36px_rgba(16,53,110,0.32)] active:shadow-[0_14px_36px_rgba(16,53,110,0.32)]',
