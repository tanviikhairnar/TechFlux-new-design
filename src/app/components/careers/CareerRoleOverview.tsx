        ...
        <div className="grid gap-12 lg:grid-cols-[1fr_340px] lg:items-start">
          ...
          >
            ...
            <CareerApplyNowButton
              ...
              role={role}
              className="inline-flex h-12 w-full items-center justify-center rounded-xl bg-gradient-to-r from-[#39AEFE] to-[#2F80ED] text-base font-semibold text-white shadow-[0_10px_28px_rgba(47,128,237,0.35)] transition-all duration-300 hover:brightness-110 active:brightness-110"
            />
          </motion.aside>
        </div>
      </section>
